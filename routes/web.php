...
Route::post('/checkout', 'CheckoutController@store')->middleware('checkUserDetails');
// Route::post('/checkout', 'OrderController@store')->name('checkout');
Route::post('/products/store-rating', [ProductController::class, 'storeRating'])->name('storeRating');
...
Route::middleware(['admin'])->group(function(){
    ...
    Route::post('/orders/{order}/reject', [OrderController::class, 'rejectPayment'])->name('reject_payment');
